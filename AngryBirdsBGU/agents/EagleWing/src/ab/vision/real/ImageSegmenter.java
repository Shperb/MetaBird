...
public class ImageSegmenter {
	...
	private static final int _trainData[][] = { { 144, 200, 216, BACKGROUND }, { 216, 232, 248, BACKGROUND },
			{ 208, 224, 240, BACKGROUND }, { 240, 248, 248, BACKGROUND }, { 184, 200, 240, BACKGROUND },
			{ 216, 232, 240, BACKGROUND }, { 168, 208, 224, BACKGROUND }, { 176, 216, 248, BACKGROUND },
			{ 208, 232, 248, BACKGROUND }, { 112, 160, 176, BACKGROUND }, { 8, 16, 56, GROUND }, { 24, 40, 96, GROUND },
			{ 48, 104, 16, GROUND }, { 192, 248, 8, GROUND }, { 24, 48, 11, GROUND }, { 64, 40, 24, HILLS },
			{ 48, 32, 16, HILLS }, { 144, 112, 80, HILLS }, { 104, 72, 48, HILLS }, { 120, 88, 64, HILLS },
			{ 160, 120, 88, HILLS }, { 88, 56, 40, HILLS }, { 72, 48, 32, HILLS }, { 48, 16, 8, SLING },
			{ 80, 40, 8, SLING }, { 120, 64, 32, SLING }, { 160, 112, 48, SLING }, { 200, 144, 88, SLING },
			{ 152, 88, 40, SLING }, { 176, 128, 64, SLING }, { 168, 112, 64, SLING }, { 208, 0, 40, RED_BIRD },
			{ 240, 216, 32, YELLOW_BIRD }, { 232, 176, 0, YELLOW_BIRD }, { 96, 168, 192, BLUE_BIRD },
			{ 80, 144, 168, BLUE_BIRD }, { 232, 232, 200, WHITE_BIRD }, { 248, 184, 72, WHITE_BIRD },
			{ 104, 224, 72, PIG }, { 160, 232, 0, PIG }, { 88, 176, 32, PIG }, { 110, 176, 12, PIG },
			{ 56, 104, 8, PIG }, { 88, 192, 240, ICE }, { 104, 192, 240, ICE }, { 120, 200, 240, ICE },
			{ 192, 240, 248, ICE }, { 144, 216, 240, ICE }, { 136, 208, 248, ICE }, { 128, 208, 248, ICE },
			{ 168, 224, 248, ICE }, { 69, 163, 187, ICE }, { 40, 160, 224, ICE }, { 176, 224, 248, ICE },
			{ 224, 144, 32, WOOD }, { 248, 184, 96, WOOD }, { 192, 112, 32, WOOD }, { 176, 88, 32, WOOD },
			{ 168, 96, 8, WOOD }, { 232, 160, 72, WOOD }, { 248, 192, 96, WOOD }, { 248, 176, 72, WOOD },
			{ 156, 112, 83, WOOD }, { 168, 88, 32, WOOD }, { 216, 146, 64, BACKGROUND }, { 80, 152, 8, BACKGROUND },
			{ 48, 56, 16, BACKGROUND }, { 40, 40, 8, BACKGROUND }, { 162, 126, 105, BACKGROUND },
			{ 168, 147, 139, BACKGROUND }, { 160, 112, 72, BACKGROUND }, { 152, 80, 24, BACKGROUND },
			{ 112, 112, 112, BACKGROUND }, { 160, 88, 24, BACKGROUND }, { 184, 160, 144, BACKGROUND },
			{ 136, 64, 16, BACKGROUND }, { 64, 176, 40, BACKGROUND }, { 184, 120, 48, BACKGROUND },
			{ 80, 80, 80, BACKGROUND }, { 0, 0, 0, BACKGROUND }, { 127, 138, 177, BACKGROUND },
			{ 81, 190, 232, BACKGROUND }, { 40, 160, 232, BACKGROUND }, { 248, 224, 80, DUCK }, { 248, 208, 32, DUCK },
			{ 248, 136, 32, DUCK }, { 240, 176, 16, DUCK }, { 128, 168, 24, WATERMELON }, { 88, 112, 16, WATERMELON },
			{ 56, 88, 16, WATERMELON } };
	...
	private static final int NEIGHBOURS[][] = { { 0, -1, 0, 1, 0, 0 }, // horizontal
																		// neighbours
	 ...
	 * 
	 * @return boolean map in the form isEdge[y][x], where isEdge[y][x] means
	 * point (x, y) is an edge
	 */
						...
						while (!q.isEmpty()) {
							...
							for (int i = -1; i < 2; i++)
								for (int j = -1; j < 2; j++) {
									...
									// if the gradient is greater than
									// threshold2
	 ...
	 * Initialise the drawing color for each types - Set minimum and maximum
	 * size of each type of object
	 */
	...
	/*
	 * Assign the 15-bit color to the most likely type using nearest neighbour
