...
public class ShowSeg implements Runnable {
	...
	public static BufferedImage drawMBRs(BufferedImage screenshot) {
		...
		// just for check
		// allocate game scene's room 
		// finOurRoom(...): method defined in ABUtil class
		List<ABObject> pig = vision.findPigsMBR();
		List<ABObject> objects = vision.findBlocksMBR();
			
		Rectangle ourRoom = ABUtil.findOurRoom(pig, objects);
		//Rectangle line = new Rectangle(ourRoom.x, ourRoom.y+ourRoom.height, ourRoom.width,1);
		...
		//////////////////////////////////////////////////////////////////////////////////////////////
		// my adds for check
		//Rectangle ourRoom1 = new Rectangle(ourRoom.x-8, ourRoom.y-8, ourRoom.width+16, ourRoom.height+16);
		// check line for white birds 
		//Rectangle line = new Rectangle(ourRoom.x, ourRoom.y+ourRoom.height, ourRoom.width, 3);
		
		//ROOM.x, 0, ROOM.width, ROOM.y + ROOM.height
		VisionUtils.drawBoundingBox(screenshot, ourRoom, Color.GREEN, Color.BLACK);
		//VisionUtils.drawBoundingBox(screenshot, line, Color.RED, Color.BLACK);
