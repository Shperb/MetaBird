...
public class TrajectoryPlanner {
    ...
    public double getGravity(Rectangle sling)
    {
        double vx = _ux*1000.0/_timeUnit;
        double vy = _uy*1000.0/_timeUnit;
        double Px0 = 0.0;
        double Px1 = -0.5*_b/_a;
        double Py0 = (_a * Px0 * Px0 + _b * Px0);
        double Py1 = (_a * Px1 * Px1 + _b * Px1);
        double dt = (Px1 - Px0)/(vx);
        //System.out.println("Px0 = "+Px0+"   Px1 = "+Px1);
        //System.out.println("Py0 = "+Py0+"   Py1 = "+Py1);
        //System.out.println("DeltaTime = " + dt);

        double a = 2*(Py1-Py0-vy*dt)/(dt*dt);
        //System.out.println("Vertical acceleration: "+a);
        return a;
    }
