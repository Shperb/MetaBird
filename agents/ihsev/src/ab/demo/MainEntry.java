...
public class MainEntry
{
    ...
    public static void main(String args[])
    {
        ...
        if (args.length > 0)
        {
            ...
            if (args.length == 1)
            {
                System.out.println("Server address specified: " + args[0]);
                ClientNaiveAgent na = new ClientNaiveAgent(args[0]);
                na.run();
            }
            else
            {
                System.out.println("Too many arguments. Please run me as:");
                System.out.println("java -jar file.jar [SERVER_IP]");
            }
        }
        else
        {
            System.out.println("No server ip specified. Running on localhost !");
